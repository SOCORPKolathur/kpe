...
class Policies_Pdf_view_Page extends StatefulWidget {
  String?pdfview;
  Policies_Pdf_view_Page(this.pdfview);

  @override
  State<Policies_Pdf_view_Page> createState() => _Policies_Pdf_view_PageState();
}

class _Policies_Pdf_view_PageState extends State<Policies_Pdf_view_Page> {
  @override
